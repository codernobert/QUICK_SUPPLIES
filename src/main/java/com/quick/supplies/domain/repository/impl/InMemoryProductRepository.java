...
public class InMemoryProductRepository implements ProductRepository{
	...
	public void addProduct(Product product) {
		String SQL = "INSERT INTO PRODUCTS (ID, owner,contact, product, UNIT_PRICE, location, weight,quantity, description) VALUES (:id, :owner, :contact, :product, :unitPrice,:location, :weight, :quantity, :description)";
	...
	public void updateProduct(Product product) {
		String sql = "UPDATE products SET owner = :owner, contact = :contact, UNIT_PRICE = :UNIT_PRICE, description = :description,product = :product , location = :location,weight = :weight, quantity = :quantity WHERE proId = :proId";
